...
You can also use the [Airflow CLI]([https://airflow.apache.org/cli.html](https://airflow.apache.org/docs/apache-airflow/stable/cli-and-env-variables-ref.html) to
