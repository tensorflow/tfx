...
flags.DEFINE_string('metadata_db_uri', None, 'Path to metadata db. (Beam)')
# host and port are required for recording KFP pipeline.
flags.DEFINE_string('host', None, 'Hostname of the metadata grpc server. (KFP)')
flags.DEFINE_integer('port', None, 'Port number of the metadata grpc server. (KFP)')
