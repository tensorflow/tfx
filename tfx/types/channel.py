...
class OutputChannel(Channel):
  ...
  def __init__(
    ...
    self._is_async_channel = is_async_channel
  ...
  def __repr__(self) -> str:
    return (
        ...
        f'_is_async_channel={self._is_async_channel}'
    )
  ...
  @property
  @doc_controls.do_not_generate_docs
  def is_async_channel(self) -> bool:
    return self._is_async_channel
