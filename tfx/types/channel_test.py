...
class ChannelTest(tf.test.TestCase):
  ...
  def testFutureProducesPlaceholder(self):
    ...
    self.assertIsInstance(future, ph.ArtifactPlaceholder)
    self.assertIs(future.channel, channel)
    self.assertIsInstance(future[0], ph.ArtifactPlaceholder)
    self.assertIsInstance(future.value, ph.ArtifactPlaceholder)
