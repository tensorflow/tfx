...
"""TFX ParquetExampleGen driver, based on the driver for CsvExampleGen"""
# This was copied over wholesale with no changes from the CsvExampleGen driver -
# it'd probably be a good idea to refactor to avoid the duplication
...
class Driver(base_driver.BaseDriver):
  """Custom driver for ParquetExampleGen."""
