...
"""TFX ModelSearch component definition."""
...
from tfx.components.model_search import driver
from tfx.components.model_search import executor
...
class ModelSearch(base_component.BaseComponent):
  """Official TFX ModelSearch component.

  #TODO(xavigonzalvo): update documentation
  ...
  def __init__(self,
    ...
    super(ModelSearch, self).__init__(
  ...
  def _create_outputs(self) -> base_component.ComponentOutputs:
    """Creates outputs for ModelSearch.

    Returns:
      ComponentOutputs object containing the dict of [Text -> Channel]
    """
    #TODO(xavigonzalvo): update outputs
