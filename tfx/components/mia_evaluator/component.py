...
"""TFX MIA Evaluator component definition."""
...
from tfx.components.mia_evaluator import executor
...
class MIAEvaluator(base_beam_component.BaseBeamComponent):
  """A MIA TFX component to evaluate models trained by a TFX Trainer component.
  ...
  def __init__(
      ...
      mia_config: mia_evaluator.MIACustomConfig = mia_evaluator.MIACustomConfig(
          output_name='heh'),
  ):
    ...
    Args:
      ...
      mia_config: Instance of mia_evaluator.MiaCustomConfig containg
        configuration settings for running the MIA evaluation.
    """
    ...
    spec = standard_component_specs.MIAEvaluatorSpec(
        examples=examples,
        model=model,
