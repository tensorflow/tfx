  ...
  def __init__(self,
    ...
    Args:
      ...
      train_args: A trainer_pb2.TrainArgs instance, containing args used for
        training. Current only splits and num_steps are available. Default
      ...
      eval_args: A trainer_pb2.EvalArgs instance, containing args used for eval.
        Current only splits and num_steps are available. Default behavior (when
        splits is empty) is evaluate on ‘eval’ splits.
