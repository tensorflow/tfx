...
# "auto" automatically detect the docker server's version.
# https://docker-py.readthedocs.io/en/stable/client.html#docker.client.DockerClient
_DEFAULT_CLIENT_API_VERSION = 'auto'
...
class LocalDockerModelServerRunner(base_runner.BaseModelServerRunner):
  ...
  def _MakeDockerClientFromConfig(
    ...
    params['version'] = config.client_api_version or _DEFAULT_CLIENT_API_VERSION
