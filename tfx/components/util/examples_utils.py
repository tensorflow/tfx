...
_CUSTOM_SPLIT_PATTERN_PROPERTY_NAME = 'custom_split_pattern'
...
def get_custom_split_patterns_key_and_property(
  ...
  """
  return _CUSTOM_SPLIT_PATTERN_PROPERTY_NAME, json.dumps(split_to_pattern)
...
def _get_custom_split_pattern(
  ...
  if not examples.has_custom_property(_CUSTOM_SPLIT_PATTERN_PROPERTY_NAME):
    return None
  custom_split_patterns = json.loads(
      examples.get_string_custom_property(_CUSTOM_SPLIT_PATTERN_PROPERTY_NAME)
  )
