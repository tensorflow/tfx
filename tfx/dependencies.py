...
def make_required_install_packages():
  ...
  return [
      ...
      'tensorflow-data-validation>=0.23.0.dev,<0.25',
      'tensorflow-model-analysis>=0.23.0.dev,<0.25',
      'tensorflow-serving-api>=1.15,<3',
      'tensorflow-transform>=0.23.0.dev,<0.25',
      'tfx-bsl>=0.23.0.dev,<0.25',
  ]
