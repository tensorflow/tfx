...
_TypeA = Dict[str, Union['_TypeA', List[int]]]
_TypeB = List[Union['_TypeB', Dict[str, int], float]]
_TypeC = Optional[Dict[str, List[Union['_TypeC', int, float]]]]
...
def _injector_4() -> OutputDict(
    ...
    e=List[List[Dict[str, int]]],
    f=Dict[str, List[Dict[str, List[float]]]]):
  return {
      'a': {'foo': [1, 2]},
      'b': [1., 2.],
      'c': {'bar': [1., 2.]},
...
def _json_compat_check_component(
    a: Optional[_TypeA] = None,
    b: Optional[_TypeB] = None,
    c: Optional[_TypeC] = None,
    d: Optional[Dict[str, Dict[str, List[int]]]] = None,
    e: Optional[List[List[Dict[str, int]]]] = None,
    f: Optional[Dict[str, List[Dict[str, List[float]]]]] = None,
):
  del a, b, c, d, e, f
