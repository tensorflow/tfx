...
def assert_no_varargs_varkw(
  ...
  if argspec.varargs or argspec.varkw:
    raise ValueError(
        'The function does not support *args or **kwargs arguments.'
    )
...
def _create_component_spec_class(
    ...
    arg_defaults: dict[str, Any],
    inputs: dict[str, type[artifact.Artifact]] | None = None,
    outputs: dict[str, type[artifact.Artifact]] | None = None,
    parameters: dict[str, Any] | None = None,
    type_annotation: type[system_executions.SystemExecution] | None = None,
    json_compatible_inputs: dict[str, Any] | None = None,
    json_compatible_outputs: dict[str, Any] | None = None,
...
def _create_executor_spec_instance(
    ...
    arg_formats: dict[str, ArgFormats],
    arg_defaults: dict[str, Any],
    return_values_optionality: dict[str, bool] | None = None,
    json_compatible_outputs: dict[str, Any] | None = None,
