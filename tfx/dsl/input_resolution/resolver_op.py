...
class InputResolutionContext:
  """Context for running input resolution."""
  # MetadataStore for MLMD read access.
  store: mlmd.MetadataStore
  # NodeInfo for the node on which input resolution is running.
...
class ResolverOp(metaclass=_ResolverOpMeta):
  ...
  def set_context(self, context: 'InputResolutionContext'):
    """Set InputResolutionContext to be used when applying the operator."""
