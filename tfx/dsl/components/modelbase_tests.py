...
from tfx.dsl.components.modelbase import ModelBase
...
class StructureModelBaseTestCase(unittest.TestCase):
  ...
  def test_handle_from_to_dict_for_class(self):
    ...
    # {'prop_0': '', '@@': TestModel1(prop_0='value 0')} is also
    # valid for from_dict, but this cannot happen when parsing for real
