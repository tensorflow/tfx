...
from tfx.dsl.components import function_parser
...
def component(func: types.FunctionType) -> Callable[..., Any]:
  ...
  * `OutputArtifact[ArtifactType]`: indicates that an output artifact object of
  ...
  This is example usage of component definition using this decorator:
      ...
      from tfx.dsl.components.base.annotations import InputArtifact
      from tfx.dsl.components.base.annotations import OutputArtifact
      from tfx.dsl.components.base.annotations import Parameter
