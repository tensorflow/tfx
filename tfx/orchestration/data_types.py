...
class RuntimeParameter(json_utils.Jsonable):
  ...
  Attributes:
    ...
    system_parameter: If True, this parameter is generated by TFX not by users.
      End users are not expected to use this argument.
  """

  def __init__(
      self,
      name: Text,
      ptype: Optional[Type[Any]] = None,
      default: Optional[Union[int, float, Text]] = None,
      description: Optional[Text] = None,
      system_parameter: bool = False):
