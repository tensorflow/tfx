    ...
    if is_execution_needed:
      try:
        ...
        if self._executor_operator:
          ...
          # Saves an in memory copy of the Execution object to execution
          # watcher. Launcher calls executor operator in process and it is a
          # blocking call, thus there won't be race condition between the
          # sidecar and the launcher to write to MLMD.
          executor_watcher.addExecution(
              execution_preparation_result.execution_metadata)
