...
def update_artifacts(
    ...
    artifacts: Iterable[artifact_lib.Artifact],
    new_artifact_state: Optional[str] = None) -> None:
  """Updates artifacts in MLMD."""
  mlmd_artifacts_to_update = []
  for artifact in artifacts:
    if new_artifact_state is not None:
      artifact.state = new_artifact_state
    mlmd_artifacts_to_update.append(artifact.mlmd_artifact)
