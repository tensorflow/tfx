...
class PipelineOpsTest(
  ...
  def _assertInputEventIncreasingIndex(
  ...
  def test_mark_intermediate_read_artifacts_as_processed(self):
    ...
    # Read and mark the 10 Model and 10 ModelBlessing artifacts as processsed.
    pipeline_ops.mark_intermediate_read_artifacts_as_processed(
    ...
    self._assertInputEventIncreasingIndex(model_events, 'model')
    self._assertInputEventIncreasingIndex(
