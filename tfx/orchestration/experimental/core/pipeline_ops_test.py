...
class PipelineOpsTest(test_utils.TfxTest, parameterized.TestCase):
  ...
  def test_initiate_pipeline_start_with_partial_run_and_subpipeline(
    ...
    with self._mlmd_connection as m:
      ...
      stats_gen = subpipeline.nodes[1].pipeline_node
      schema_gen = subpipeline.nodes[2].pipeline_node
      subpipeline_end = subpipeline.nodes[3].pipeline_node
      ...
      if run_subpipeline:
        ...
        stats_gen.execution_options.skip.CopyFrom(skip)
        schema_gen.execution_options.skip.CopyFrom(skip)
        subpipeline_end.execution_options.skip.CopyFrom(skip)
