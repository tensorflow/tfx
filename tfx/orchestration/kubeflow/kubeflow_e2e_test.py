...
class KubeflowEndToEndTest(kubeflow_test_utils.BaseKubeflowTest):
  ...
  def _get_artifacts_with_type_and_pipeline(
    ...
    # 1. Finds the pipeline context according to its name.
    ...
    # 2. Finds the artifacts associated with the pipeline context.
    ...
    # 4. Filters the returned artifacts according to their types.
    result = []
