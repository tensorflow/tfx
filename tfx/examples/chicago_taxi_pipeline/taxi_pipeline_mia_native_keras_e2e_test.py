...
"""E2E Tests for tfx.examples.chicago_taxi_pipeline.taxi_pipeline_mia_native_keras."""
...
from tfx.examples.chicago_taxi_pipeline import taxi_pipeline_mia_native_keras
...
class TaxiPipelineNativeKerasEndToEndTest(
  ...
  def assertPipelineExecution(self) -> None:
    ...
    self.assertExecutedOnce('MIAEvaluator')
  ...
  def testTaxiPipelineNativeKeras(self):
    BeamDagRunner().run(
        taxi_pipeline_mia_native_keras._create_pipeline(
