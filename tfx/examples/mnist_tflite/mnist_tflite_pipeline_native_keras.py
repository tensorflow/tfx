...
_pipeline_name = 'mnist_tflite_native_keras'

# This example assumes that MNIST data is stored in ~/mnist_tflite/data and
# the utility function is in ~/mnist_tflite. Feel free to customize as needed.
_mnist_root = os.path.join(os.environ['HOME'], 'mnist_tflite')
_data_root = os.path.join(_mnist_root, 'data')
# Python module file to inject customized logic into the TFX components. The
# Transform and Trainer both require user-defined functions to run successfully.
_module_file = os.path.join(_mnist_root, 'mnist_tflite_utils_native_keras.py')
...
#   $python mnist_tflite_pipeline_native_keras.py
