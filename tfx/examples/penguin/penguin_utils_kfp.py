...
"""Python source which includes pipeline functions for Cloud Penguin KFP example.
...
# from tensorflow_cloud.core
# import machine_config
# from tensorflow_cloud.tuner
# import tuner as cloud_tuner
...
#       # https://github.com/tensorflow/cloud/blob/master/src/python/
#       tensorflow_cloud/core/machine_config.py
