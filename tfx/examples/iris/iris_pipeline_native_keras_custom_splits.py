...
_pipeline_name = 'iris_native_keras_custom_splits'
...
def _create_pipeline(pipeline_name: Text, pipeline_root: Text, data_root: Text,
  ...
  output = example_gen_pb2.Output(
      split_config=example_gen_pb2.SplitConfig(splits=[
          example_gen_pb2.SplitConfig.Split(name='training', hash_buckets=3),
          example_gen_pb2.SplitConfig.Split(name='evaluating', hash_buckets=2),
          example_gen_pb2.SplitConfig.Split(name='testing', hash_buckets=1)
      ]))
  ...
  if enable_tuning:
    tuner = Tuner(
        ...
        train_args=trainer_pb2.TrainArgs(splits=['training'], num_steps=20),
        eval_args=trainer_pb2.EvalArgs(splits=['evaluating'], num_steps=5))
  ...
  trainer = Trainer(
      ...
      train_args=trainer_pb2.TrainArgs(splits=['training'], num_steps=100),
      eval_args=trainer_pb2.EvalArgs(splits=['evaluating'], num_steps=5))
...
#   $python iris_pipeline_native_keras_custom_splits.py
