...
def _create_ranking_model(tf_transform_output, hparams) -> tf.keras.Model:
  ...
  if 'inputs' == flatten_list._call_spec.arg_names[0]:  # pylint: disable=protected-access
  ...
  if 'inputs' == restore_list._call_spec.arg_names[0]:  # pylint: disable=protected-access
