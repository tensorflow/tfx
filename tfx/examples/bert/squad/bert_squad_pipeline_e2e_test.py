...
"""E2E Tests for tfx.examples.bert.squad.bert_squad_pipeline."""
...
from tfx.examples.bert.squad import bert_squad_pipeline
from tfx.orchestration import metadata
from tfx.orchestration.beam.beam_dag_runner import BeamDagRunner


class SquadPipelineNativeKerasEndToEndTest(tf.test.TestCase):

  def setUp(self):
    super(SquadPipelineNativeKerasEndToEndTest, self).setUp()
    ...
    self._module_file = os.path.join(
        os.path.dirname(__file__), 'bert_squad_utils.py')
  ...
  def testSquadPipelineNativeKeras(self):
    pipeline = bert_squad_pipeline._create_pipeline(
