...
"""BERT Question Answering example on Squad using TFX."""
...
# This example assumes that Squad data is stored in ~/bert/squad/data and the
# utility function is in ~/bert/squad. Feel free to customize as needed.
_bert_squad_root = os.path.join(os.environ['HOME'], 'bert', 'squad')
_data_root = os.path.join(_bert_squad_root, 'data')
# Python module file to inject customized logic into the TFX components. The
# Transform and Trainer both require user-defined functions to run successfully.
_module_file = os.path.join(_bert_squad_root, 'bert_squad_utils.py')
