...
echo "Starting local training for data output by flink..."
...
WORKING_DIR=$DATA_DIR/train/flink_chicago_taxi_output
...
python trainer/task.py \
    --train-files ./data/train/flink_chicago_taxi_output/train_transformed-* \
    --verbosity INFO \
    --job-dir $MODEL_DIR \
    --train-steps 10000 \
    --eval-steps 5000 \
    ...
    --schema-file ./data/flink_tfdv_output/schema.pbtxt \
    --eval-files ./data/eval/flink_chicago_taxi_output/eval_transformed-*
