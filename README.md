...
------------------------------------------------------------------------- | ---------------- | ----------- | ------- | ----------------- | -------------------------- | ------------------- | ------------------------- | ---------------------- | -------------------- | -------
[GitHub master](https://github.com/tensorflow/tfx/blob/master/RELEASE.md) | 2.32.0           | 1.3.0       | 2.0.0   | nightly (1.x/2.x) | 1.3.0                      | 1.3.0               | 0.34.1                    | 2.6.0                  | 1.3.0                | 1.3.0
1.3.4                                                                     | 2.32.0           | 1.3.0       | 2.0.0   | 1.15.0 / 2.6.0    | 1.3.0                      | 1.3.0               | 0.34.1                    | 2.6.0                  | 1.3.0                | 1.3.0
